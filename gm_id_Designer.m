...
assignin('base', 'current_dev', 'nch'); % ??????? ?? NMOS
...
fig = figure('Name', 'TSMC 65nm Design Space', 'Position', [100, 100, 1200, 400], 'Color', 'w');
update_main_plots(fig); 

%% ========================================================================
%  --- Main Plotting Function (Supports NMOS/PMOS Toggling) ---
% =========================================================================
function update_main_plots(fig)
    ...
    set(fig, 'Name', sprintf('TSMC 65nm Design Space - [%s]', title_str));
